  ...
  return (
    <>
      {statusResponse ? (
        ...
        <>
          <GeneralMdText margin="1rem 0" fontSize="34px" lineHeight="40px" textAlign="center" color="var(--header-color)" textTransform="capitalize" fontWeight="400">Merchants</GeneralMdText>
          <FormWrapper>
              ...
              <ContentRow>
                ...
                <Content2Column2>
                  <CustomDiv position="relative">
                    <Controller
                      ...
                      render={({ field }) => (
                        <>
                          <DatePicker placeholder="Scheduled Date" onChange={(date) => field.onChange(date)}
                ...
                <Content2Column2>
                  <CustomDiv position="relative">
                    <Controller
                      ...
                      render={({ field }) => (
                        <>
                          <TimePicker placeholder="Scheduled Time" onChange={(time) => field.onChange(time)} selected={field.value} defaultOpenValue={moment('00:00:00', 'HH:mm:ss')} />
                          <IconHolder>
                ...
                <ContentFullColumn>
                  <Checkbox onChange={handleChange}
                    value={checked} label="I have a website" />
                </ContentFullColumn>
